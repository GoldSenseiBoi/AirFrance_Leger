<?php
	...
	public function selectWherePassager($idPassager){
		...
		public function selectAllMembresEquipage(){
			$requete = "SELECT me.ID_MembreEquipage, me.ID_Personne, p.Nom, p.Prenom, me.Role, me.DateEmbauche, me.ID_Vol FROM membres_equipage me JOIN personnes p ON me.ID_Personne = p.ID_Personne";
			$select = $this->unPDO->prepare($requete);
			$select->execute();
			return $select->fetchAll();
		}
